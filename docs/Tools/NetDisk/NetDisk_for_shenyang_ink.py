...
UPLOAD_FOLDER = '~/Desktop/zyy/CODE/websites/shenyang_ink/docs/Tools/NetDisk/upload_files'
...
def index():
    ...
    return '''
    <!doctype html>
    <title>老仓库网盘(shenyang.ink版)</title>
    <h1>上传文件到老仓库网盘(shenyang.ink版)</h1>
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=5001, debug=True) # 这行代码告诉你的Flask应用在所有可用的IP地址上侦听，并在5001端口上运行。
